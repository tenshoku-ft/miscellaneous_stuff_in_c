...
int random_xorshift128_new(random_xorshift128_t**pself,uint32_t x,uint32_t y,uint32_t z,uint32_t w){
...
float random_xorshift128_normal_f32(random_xorshift128_t*self,float mean,float stddev){
	return mean+stddev*random_xorshift128_standard_normal_f32(self);
}
